const TESTI_PREVISIONI = Object.freeze({
  ...
  en: {
    fattori: {
      ...
      passoGaraRecente: "Recent race pace",
    ...
    note: {
      ...
      evidenzaAlta:
        "The advantage is weighted according to its relevance to the circuit characteristics.",
      evidenzaBassa:
  ...
  fr: {
    fattori: {
      ...
      passoGaraRecente: "Rythme de course récent",
    ...
    note: {
      ...
      evidenzaAlta:
        "L'avantage est pondéré selon sa pertinence pour les caractéristiques du circuit.",
      evidenzaBassa:
  ...
  pt: {
    fattori: {
      ...
      passoGaraRecente: "Ritmo de corrida recente",
    ...
    note: {
      ...
      evidenzaAlta:
        "A vantagem é ponderada de acordo com a relevância para as características do circuito.",
      evidenzaBassa:
  ...
  es: {
    fattori: {
      ...
      passoGaraRecente: "Ritmo de carrera reciente",
    ...
    note: {
      ...
      evidenzaAlta:
        "La ventaja se pondera según su relevancia para las características del circuito.",
      evidenzaBassa:
  ...
  de: {
    fattori: {
      ...
      passoGaraRecente: "Jüngste Rennpace",
    ...
    note: {
      ...
      evidenzaAlta:
        "Der Vorteil wird entsprechend seiner Relevanz für die Streckencharakteristik gewichtet.",
      evidenzaBassa:
